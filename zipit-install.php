...
shell_exec('wget https://github.com/jeremehancock/zipit/zipball/master --no-check-certificate -O zipit.zip; rm -rf zipit unzip zipit.zip; mv jeremehancock-zipit-* zipit; rm zipit.zip');
